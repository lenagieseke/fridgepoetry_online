...
class Magnet
{
    ...
    setPosition(newX, newY)
    {
        ...
        // Check if Magnet (with padding, border, etc -> the DOM element) is in bounds
    ...
    moveMagnet(mouseX, mouseY){
        ...
        let containerWidth = fridge.clientWidth;
        let containerHeight = fridge.clientHeight;
        // Getting the position isn't as easy because of the way we used CSS to position it
        // But we now that the width and height are both 90% of the body
        // Then it is offset in the middle, meaning 5% to the left and 5% down from the top of body
        ...
        // Because our x and y are relative values from 0 to 1 we need to convert our mouse position
