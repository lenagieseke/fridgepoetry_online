 ...
 * Notes: SOLUTION
 *
 * The following example uses in global mode,
...
// As described in the Note above, we are working with 
...
function loadStringsFromFile(filePath, callback)
{
    ...
    client.onloadend = function() {
        ...
        // console.log(client.responseText.split("\n"));
        // fridge.words = client.responseText.split("\r\n");
        // fridge.words = client.responseText.split(/\r?\n/);
        fridge.words = client.responseText.split(/[\r\n]+/);
